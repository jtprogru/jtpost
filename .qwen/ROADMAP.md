...
4. 🔄 Поддержка альтернативных хранилищ данных (SQLite, PostgreSQL, Git)
...
### Спринт 1: Импорт постов (1-2 недели)
...
### Спринт 2: Удаление блога (3-5 дней)
