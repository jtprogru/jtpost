...
- [ ] Добавить колонку "ID" в `jtpost list`
- [ ] Опциональный флаг `--no-id` для скрытия ID
- [ ] Добавить колонку ID в Web UI (опционально)
- [ ] Добавить отображение ID в модальном окне
- [ ] Добавить кнопку "Копировать ID"

#### 7.4 Чистка Web UI 🔴
- [ ] Удалить раздел "Публикация в Telegram" из модального окна
- [ ] Удалить функции `openPublishModal()`, `publishPost()`
- [ ] Оставить кнопку "📨 Опубликовать" в таблице постов
- [ ] Вынести публикацию в отдельную модалку подтверждения
